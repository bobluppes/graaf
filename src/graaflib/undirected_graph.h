...
namespace graaf {
    ...
    class undirected_graph final : public graph<VERTEX_T, EDGE_T, GRAPH_SPEC::UNDIRECTED>{
        private:
            ...
            vertex_ids_t make_sorted_pair(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs) const {
            ...
            [[nodiscard]] bool do_has_edge(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs) const noexcept override {
                return this->edges_.contains(make_sorted_pair(vertex_id_lhs, vertex_id_rhs));
            }
            ...
            void do_add_edge(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs, EDGE_T edge) override {
                ...
                this->edges_.emplace(make_sorted_pair(vertex_id_lhs, vertex_id_rhs), std::move(edge));
            }
