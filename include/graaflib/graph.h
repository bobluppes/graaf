...
class graph
{
  public:
     ...
     */
    [[nodiscard]] bool constexpr is_directed() const
    {
     ...
     */
    [[nodiscard]] bool constexpr is_undirected() const
    {
     ...
     */
    [[nodiscard]]
    vertex_id_to_vertex_t const& get_vertices() const noexcept
    {
        return vertices_;
    }
     ...
     */
    [[nodiscard]]
    edge_id_to_edge_t const& get_edges() const noexcept
    {
        return edges_;
    }
     ...
     */
    [[nodiscard]]
    bool has_vertex(vertex_id_t vertex_id) const noexcept;
    ...
    [[nodiscard]]
    bool has_edge(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs) const noexcept;
     ...
     */
    [[nodiscard]]
    vertex_t& get_vertex(vertex_id_t vertex_id);
    ...
    [[nodiscard]]
    vertex_t const& get_vertex(vertex_id_t vertex_id) const;
     ...
     */
    [[nodiscard]]
    edge_t& get_edge(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs);
     ...
     */
    [[nodiscard]]
    edge_t const& get_edge(vertex_id_t vertex_id_lhs, vertex_id_t vertex_id_rhs) const;
     ...
     */
    [[nodiscard]]
    edge_t& get_edge(edge_id_t const& edge_id);
     ...
     */
    [[nodiscard]]
    edge_t const& get_edge(edge_id_t const& edge_id) const;
     ...
     */
    [[nodiscard]]
    vertices_t get_neighbors(vertex_id_t vertex_id) const;
