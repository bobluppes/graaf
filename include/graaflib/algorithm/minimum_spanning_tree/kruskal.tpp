...
namespace detail
{
    ...
    void do_merge_sets(vertex_id_t vertex_a,
                       vertex_id_t vertex_b,
                       std::unordered_map<vertex_id_t, vertex_id_t>& parent,
                       std::unordered_map<vertex_id_t, vertex_id_t>& rank)
    {
    ...
    struct edge_to_process : public weighted_edge<T>
    {
      public:
        ...
        bool operator!=(edge_to_process const& e) const noexcept
        {
    ...
    graph<V, E, graph_type::UNDIRECTED> const& graph)
{
    ...
    std::sort(edges_to_process.begin(),
              edges_to_process.end(),
    ...
    for(auto const& edge: edges_to_process)
    {
