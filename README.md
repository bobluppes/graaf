...
<p align="center">
  Graaf is a general-purpose graph library implemented in C++. Graaf allows users to easily create, modify, and query graphs. It is designed as a lightweight alternative to Boost Graph.
</p>
